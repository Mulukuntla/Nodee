async function dayExpense(event){
    ...
    const res=await axios.post(`http://16.170.220.229:4000/expense/day-expense`,obj,{ headers: {"Authorization" : token} })
...
async function weekExpense(event){
    try{
        ...
        const token=localStorage.getItem("token")
        const res=await axios.post(`http://16.170.220.229:4000/expense/week-expense`,obj,{ headers: {"Authorization" : token} })
...
async function monthExpense(event){
    try{
        ...
        const token=localStorage.getItem("token")
        const res=await axios.post(`http://16.170.220.229:4000/expense/month-expense`,obj,{ headers: {"Authorization" : token} })
        const day=document.getElementById("tables")
        const b=
        `
        <thead>
